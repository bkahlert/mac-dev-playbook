...
curl -fsSkL -m 10 --retry 5 https://hc-ping.com/6f94b61e-adb7-4b79-ae6f-cc14a3ac702e/start
...
curl -fsSkL -m 10 --retry 5 --data-raw "$m" "https://hc-ping.com/6f94b61e-adb7-4b79-ae6f-cc14a3ac702e$([ $? -ne 0 ] && echo -n /fail)"